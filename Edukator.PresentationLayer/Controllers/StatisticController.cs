...
namespace Edukator.PresentationLayer.Controllers
{
    public class StatisticController : Controller
    {
        public IActionResult Index()
        {
            ...
            ViewBag.lastCoursePrice = context.Courses.Where(x => x.CourseID == 3).Select(y => y.Price).FirstOrDefault();
            
         ViewBag.getTitleByCourseID3 = context.Courses.Where(x => x.CategoryID == 2).Select(y => y.Title).FirstOrDefault();
